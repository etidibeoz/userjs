...
// 0103: set home and new window page
// about:home for activity stream (see 0105)
user_pref("browser.startup.homepage", "about:blank");

// 0104: set new tab page
// false=blank page, true=activity stream (see 0105)
